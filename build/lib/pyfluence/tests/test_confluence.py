...
class TestConfluence(TestCase):
    _confluence = None  # type: co.Confluence
    ...
    def setUpClass(cls):
        ...
        cls._confluence = co.Confluence(cls._config['username'],cls._config['password'],cls._config['host'])

        try:
            cls._confluence.create_space(cls._config['test_space'],"Test Space","Test Space Description")
        except co.ConfluenceResponseError as e:
    ...
    def test_content(self):
        ...
        # delete content
        self._confluence.delete_content(id=content_ob['id'])
